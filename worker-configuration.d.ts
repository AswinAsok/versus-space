/* eslint-disable */
// Env bindings generated by Wrangler from wrangler.jsonc (hash: 3800eee6fa5191068e058e84c8d294ac)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	AUTH_EMAIL_FROM: "auth@versus.space";
	BETTER_AUTH_URL: "https://versus-space-staging.aswinasokofficial.workers.dev" | "https://versus.space";
	DODO_PRO_PRODUCT_ID: "pdt_0NV8Drnkm6tgkmShyY2HR";
	MAINTENANCE_MODE: "false";
	SUPERADMIN_EMAILS: "aswinasokofficial@gmail.com";
	BETTER_AUTH_SECRET: string;
	DODO_WEBHOOK_KEY: string;
	RESEND_API_KEY: string;
	POLL_ROOMS: DurableObjectNamespace<import("./worker/index").PollRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PollRoom";
	}
	interface StagingEnv {
		DB: D1Database;
		ASSETS: Fetcher;
		AUTH_EMAIL_FROM: "auth@versus.space";
		BETTER_AUTH_URL: "https://versus-space-staging.aswinasokofficial.workers.dev";
		DODO_PRO_PRODUCT_ID: "pdt_0NV8Drnkm6tgkmShyY2HR";
		MAINTENANCE_MODE: "false";
		SUPERADMIN_EMAILS: "aswinasokofficial@gmail.com";
		BETTER_AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "BETTER_AUTH_URL" | "DODO_PRO_PRODUCT_ID" | "MAINTENANCE_MODE" | "SUPERADMIN_EMAILS" | "BETTER_AUTH_SECRET" | "DODO_WEBHOOK_KEY" | "RESEND_API_KEY">> {}
}
