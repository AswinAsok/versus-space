...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      'Yes! The free plan lets you create up to 3 polls with unlimited votes. Free polls auto-close after 15 minutes and are public. For unlimited polls, custom timers, private access keys, vote limiting, and analytics, upgrade to Pro for just $1 - a one-time lifetime payment.',
  },
  {
