    ...
    <div className={styles.container}>
      <article className={styles.monologue}>
        ...
        <p>
          ...
          formula already worked. this app is just a medium where people can create more like that.
        </p>

        <p>
          being developed in a hackathon, the primary objective was to get it{' '}
        ...
        <p>
          and <strong>MORE OVER</strong>, I was glad. i built something <em>I used</em>.
        </p>

        <p>for the next couple of days i played with it. started fights between topics.</p>

        <p>
          like i dropped a message about a poll between monkeytype and 10fastfingers in their
          discord.
        </p>
        ...
        <p>
          and it was <strong>FUN</strong> to watch. something you built being used.
        </p>
        ...
        <p>
          but i still wanted to launch it publicly. and maybe reach{' '}
          <a
            href="https://neal.fun"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p>
          and <strong>IT WAS A FUN RIDE</strong>
        </p>
